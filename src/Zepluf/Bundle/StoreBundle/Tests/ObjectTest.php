...
use Zepluf\Bundle\StoreBundle\Object;
...
class ObjectTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMagicGet(){
        $this->object->set('key', 'value');
        $this->assertEquals($this->object->key, 'value');
    }

    public function testMagicGet2(){
        $this->object->set('key', 'value');
        $this->assertEquals($this->object->getKey(), 'value');
    }
    ...
    public function testSetArray(){
        ...
        $this->assertEquals($this->object->get('key1'), 'value1');
        $this->assertEquals($this->object->get('key2'), 'value2');
    }

    public function testGetArray(){
        $array = array('key1' => 'value1', 'key2' => 'value2');
        $this->object->setArray($array);
        $this->assertEquals($this->object->getArray(), $array);
    }
    ...
    public function testSerialize(){
        ...
        $this->assertEquals($this->object->serialize(), 'a:2:{s:4:"key1";s:13:"s:6:"value1";";s:4:"key2";s:13:"s:6:"value2";";}');
    }
