...
namespace Zepluf\Bundle\RiStoreBundle\Templating\Helper;

use plugins\riPlugin\Plugin;
use Symfony\Component\Templating\Helper\Helper;
use Zepluf\Bundle\RiStoreBundle\HoldersHelperEvents;
use Zepluf\Bundle\RiStoreBundle\Event\HoldersHelperEvent;
...
class HoldersHelper extends Helper{
    ...
    public function get($holder){
        ...
        Plugin::get('event_dispatcher')->dispatch(HoldersHelperEvents::onHolderStart, $event);
        Plugin::get('event_dispatcher')->dispatch(HoldersHelperEvents::onHolderStart . '.' . $holder, $event);
		...
		Plugin::get('event_dispatcher')->dispatch(HoldersHelperEvents::onHolderEnd, $event);
        Plugin::get('event_dispatcher')->dispatch(HoldersHelperEvents::onHolderEnd . '.' .$holder, $event);
