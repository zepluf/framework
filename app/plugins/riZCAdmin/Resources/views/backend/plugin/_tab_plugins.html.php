    ...
    <div class="span10 col-right">
        <table class="table tablesorter" id='pluginGrid'>
            ...
            <tr class="<?php echo in_array($plugin['code_name'], $core) ? 'core' : 'noncore';?>">
                ...
                <td>
                    <a class="toggle-plugin installation install" <?php echo $plugin["installed"] ? 'style="display:none"' : '' ?> href="<?php echo $view['router']->generate('riplugin_admin_plugins_install', array('plugin' => $plugin['code_name']));?>">
                        <?php echo $view['translator']->trans('install')?>
                    </a>

                    <a class="toggle-plugin installation uninstall" <?php echo !$plugin["installed"] ? 'style="display:none"' : '' ?> href="<?php echo $view['router']->generate('riplugin_admin_plugins_uninstall', array('plugin' => $plugin['code_name']))?>">
                        <?php echo $view['translator']->trans('un-install')?>
                    </a>
                </td>
                <td>
                    <a class="toggle-plugin activation activate <?php echo $plugin["activated"] ? 'act' : '' ?>" <?php echo !$plugin["installed"] || $plugin["activated"] ? 'style="display:none"' : '' ?> href="<?php echo $view['router']->generate('riplugin_admin_plugins_activate', array('plugin' => $plugin['code_name']))?>">
                        <?php echo $view['translator']->trans('activate')?>
                    </a>

                    <a class="toggle-plugin activation deactivate <?php echo !$plugin["activated"] ? 'deact' : '' ?>" <?php echo !$plugin["installed"] || !$plugin["activated"] ? 'style="display:none"' : '' ?> href="<?php echo $view['router']->generate('riplugin_admin_plugins_deactivate', array('plugin' => $plugin['code_name']))?>">
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="toggle-plugin deactivate" <?php echo $plugin["installed"] && $plugin["activated"] ? '':'style="display:none"'; ?> href="<?php echo $view['router']->generate('riplugin_admin_plugins_reset', array('plugin' => $plugin['code_name']))?>"><i class="icon-refresh"></i> <?php echo $view['translator']->trans('Reload Settings')?></a></li>
