 ...
 * file of ZePLUF
 */
$view['loader']->load(array('jquery.lib', 'bootstrap.lib', 'jquery.snippet.lib', 'jquery.form.lib', 'jquery.gritter.lib', 'bundles:StoreBundle:js/jquery.tablesorter.js', 'bundles:StoreBundle:css/style.css', 'bundles:StoreBundle:js/modal.js', 'ritools.lib', 'bundles:StoreBundle:css/plugins.css'));
?>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.modal-link').bind('click', function (e) {
            $.ajax({
                url: '<?php echo $view['router']->generate('plugins_admin_info');?>',
...
<div class="menus pull-right">
    <ul class="nav nav-pills" id="tabPlugin">
        <li class="active">
            <a href="#plugins"><?php echo $view['translator']->trans('Plugins')?></a>
        </li>
        <!--<li><a href="#install"><?php echo $view['translator']->trans('Install')?></a></li>
        <li><a href="#feature"><?php echo $view['translator']->trans('Featured')?></a></li>-->
        <li><a href="#about"><?php echo $view['translator']->trans('About')?></a></li>
    </ul>
</div>
...
<div class="row-fluid show-grid plugins">
    ...
    <div class="tab-content" style="width: 100%;">
        <div class="tab-pane active" id="plugins">
            <?php echo $view->render('bundles:StoreBundle:backend/plugin/_tab_plugins.html.php', array('plugins' => $plugins, 'core' => $core));?>
        </div>
        <div class="tab-pane" id="settings">

        </div>
        <div class="tab-pane" id="install">
            <?php echo $view->render('bundles:StoreBundle:backend/plugin/_tab_install.html.php');?>
        </div>
...
<div class="modal" id="myModal" style="display: none">
    <div class="modal-header">
        ...
        <h3><?php echo $view['translator']->trans('Plugin Info')?></h3>
    </div>
    <div class="modal-body">

    </div>
    <div class="modal-footer">
        <button class="close btn" data-dismiss="modal"><?php echo $view['translator']->trans('Close')?></button>
    </div>
</div>
<script>
    jQuery(function () {
