...
<div class="span2 col-left">
    <ul class="nav nav-pills nav-stacked menu-contact">
        <li class="active"><a href="#"><?php echo $view['translator']->trans('Custom Contract Forms')?></a></li>
        <li><a href="#"><?php echo $view['translator']->trans('Saved Forms Submission')?></a></li>
        <li><a href="#"><?php echo $view['translator']->trans('General Setting')?></a></li>
    </ul>
</div>
<div class="span10 col-right">
    <form class="form-horizontal ajax-form" method="POST" id="form-config" action="<?php echo $view['router']->generate('plugins_admin_configs_settings', array(), 'NONSSL', false, 'ri.php')?>" >
    <input type="hidden" name="riname" value="<?php echo $riname;?>">
    <table class="table settings">
        <tr>
            <th colspan="2" style="border-top: none;"><?php echo $view['translator']->trans('EDIT PLUGIN RISSU')?></th>
        </tr>
        <tr>
